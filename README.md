...
3. Make sure that environment variables are correctly set:
   Set the environment variable REACT_APP_GITHUB_AUTH to the correct value.
   Its value is your username:password encoded in base 64.
   Ex: https://www.base64encode.org/ picard:aaobg0 should give:

   ```bash
   export REACT_APP_GITHUB_AUTH="cGljYXJkOmFhb2JnMA=="
   ```

4. Edit `package.json` `proxy` value to configure your server.
